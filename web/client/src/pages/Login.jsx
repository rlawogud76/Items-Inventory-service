  ...
  return (
    <div className="min-h-screen bg-dark-400 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-dark-300 rounded-xl p-6 border border-dark-100 space-y-6">
          {/* Discord 로그인 */}
          <button
            onClick={handleDiscordLogin}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#5865F2] hover:bg-[#4752C4] rounded-lg font-medium transition-colors"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-dark-300 text-gray-500">또는</span>
            </div>
          </div>
          ...
          <form onSubmit={handleDevLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-dark-200 hover:bg-dark-100 rounded-lg font-medium transition-colors disabled:opacity-50"
            >
              <LogIn size={18} />
