...
**`/재고물품추가`**
- 새로운 아이템을 재고 목록에 추가합니다.
- 예: `/재고물품추가 카테고리:해양 아이템:산호 초기수량:20 충족수량:100`

**`/재고물품제거`**
- 재고 목록에서 아이템을 제거합니다.
- 예: `/재고물품제거 카테고리:해양 아이템:산호`
...
- 예: `/제작품목추가 카테고리:채광 제작품:곡괭이 초기수량:0 충족수량:10 재료1:철괴 재료1수량:3 재료2:나무 재료2수량:2`
...
**`/레시피수정`**
- 제작품의 레시피를 수정합니다.
- 예: `/레시피수정 카테고리:채광 제작품:곡괭이 재료1:철괴 재료1수량:5`
